  createCanvas = {  
    ...
    mouseY: 0,
    lastX: -1, // Variables pour la prÃ©cÃ©dente position de la souris
    lastY: -1,
    mouseDown: false, // Variable pour vÃ©rifer que le boutton de la souris soit appuyÃ©e pour commencer Ã  dessiner
    context: null,

    initCanvas() { // Pour crÃ©er le canvas
        ...
        this.context.lineCap = 'round'; // ExtrÃ©mitÃ© du trait
    ...
    getMousePos(e) { // Pour avoir la position de la souris
        ...
        if (e.offsetX) {
            ...
            this.mouseX = e.layerX; // Retourne les coordonnÃ©es sur l'axe verticale sur l'event en cours
            this.mouseY = e.layerY; // Retourne les coordonnÃ©es sur l'axe horizontale sur l'event en cours
        }
    },
    ...
    drawLine(x, y) { // Pour dessiner des traits
        ...
        this.context.beginPath();                       // DÃ©but du chemin
        this.context.moveTo(this.lastX, this.lastY);    // Point de dÃ©part
        this.context.lineTo(x, y);                      // TracÃ© de la ligne
    ...
    draw() {
        canvas[0].addEventListener('mousedown', (e) => { 
            ...
            createCanvas.drawLine(createCanvas.mouseX, createCanvas.mouseY);    // On commence Ã  dessiner
        }, false);
        ...
        window.addEventListener('mouseup', () => {                          // Quand le bouton de la souris n'est plus down
            ...
            createCanvas.lastX = -1;                                              // La derniÃ¨re position de la souris est -1 pour indiquer qu'il y a un nouveau chemin
            createCanvas.lastY = -1;                                                 
        }, false);
        
        // MÃªme chose mais pour les tablettes et smartphones
