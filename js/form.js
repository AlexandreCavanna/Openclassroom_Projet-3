form = {
    ...
    reservationSuccess() {
        this.buttonSucess.addEventListener("click", () => {
            ...
            sessionStorage.setItem("stationName", this.nomStation.textContent);
